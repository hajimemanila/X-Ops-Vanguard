...
| **[Gemini Command Module](./tools/04_gemini-command-module)** | A UserScript designed to transform the Google Gemini UI into a keyboard-centric command cockpit. It can make directly into your knowledge base (Obsidian) | ✅ **Active** |
